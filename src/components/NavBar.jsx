          ...
          <div className="flex justify-between h-20">
            <div className="flex items-center">
              <Link to="/" className="flex-shrink-0 flex items-center space-x-3 group">
                <img 
                  src="https://ia601201.us.archive.org/4/items/logo_20250509_20250509_2113/logo.png" 
                  alt="Sabores de Iguazú" 
                    ...
                    <div className="py-1">
                      {categories.map((category) => (
                        <Link
                          ...
                          className="block px-4 py-2 text-sm text-gray-700 hover:bg-primary-50 hover:text-primary-600 capitalize"
                        >
                          {category}
                        </Link>
                      ))}
          ...
          <div className="px-4 pt-2 pb-3 space-y-2">
            ...
            {categories.map((category) => (
              <Link
                key={category}
                to={`/category/${category}`}
                className="block py-2.5 text-base font-medium text-gray-700 hover:text-primary-600 hover:bg-primary-50 rounded-lg px-4 transition-colors duration-200 capitalize"
              >
                {category}
              </Link>
            ))}
